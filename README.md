...
1. [Basic usage](#basic-usage)
   ...
   1. [Applications](#applications)
      1. [OpenAPI / Swagger](#using-lodata-with-openapi--swagger)
      1. [Microsoft Excel](#using-lodata-with-excel)
      1. [Microsoft PowerBI](#using-lodata-with-powerbi)
      1. [Microsoft PowerApps](#using-lodata-with-powerapps)
1. [Drivers](#drivers)
   1. [Database](#database)
   1. [Redis](#redis)
