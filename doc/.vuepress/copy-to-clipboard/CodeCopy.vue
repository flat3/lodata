<template>
  <div class="code-copy absolute flex items-center right-10" style="top: 0.6rem">
    <span :class="copying ? '' : 'hidden'" class="transition-opacity duration-500 mr-2 text-xs font-sans text-gray-500">Copied!</span>
    <svg @click="copyToClipboard" aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true"
...
export default {
  ...
  methods: {
    copyToClipboard(el) {
      ...
      gtag && gtag('event', 'copy', label && {'event_label': label});
