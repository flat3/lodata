...
#[
    ...
    LodataCollection(name: 'ThreeThree', underlyingType: Colour::class),
    ...
    LodataEnum(name: 'Nine', enum: Colour::class),
    LodataEnum(name: 'NineOne', enum: Colour::class),
    LodataEnum(name: 'NineTwo', enum: MultiColour::class),
